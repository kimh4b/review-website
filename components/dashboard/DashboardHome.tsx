...
export function DashboardHome({ onNeedsAttention }: DashboardHomeProps) {
    ...
    const fetchDashboardData = async () => {
        ...
        try {
            ...
            const recent: FeedbackItem[] = allResponses
                .slice(0, 5)
                .map((r: any) => {
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="text-sm text-gray-500">
                            Across {stats.totalSurveys} survey
                            {stats.totalSurveys !== 1 ? "s" : ""}
                        </div>
                    </CardContent>
                </Card>
                ...
                <Card>
                    ...
                    <CardContent>
                        ...
                        <div className="text-sm text-gray-500">
                            {stats.positiveCount} positive responses
                        </div>
                    </CardContent>
                </Card>
                ...
                <CardContent>
                    {recentFeedback.length === 0 ? (
                        <div className="text-center py-8 text-gray-400 text-sm">
                            No feedback yet — share your survey QR codes to get
                            started
                        </div>
                    ) : (
                  ...
                  `}
                                    ...
                                    <div className="flex-1 min-w-0">
                                        ...
                                        {feedback.sentiment === "negative" && (
  <div className="mt-2 inline-flex items-center gap-2 text-sm text-red-600 bg-red-100 px-3 py-1 rounded-full border border-red-200">
